...
std::tuple<std::string_view, std::vector<std::string>, std::vector<transport::Stop*>, bool> JsonManager::FillBuses(const json::Dict& dictionary, transport::TransportCatalogue& catalogue) const{
    std::string_view bus = dictionary.at("name").AsString();
    std::vector<std::string> stops;
    std::vector<transport::Stop*> ptrs;
