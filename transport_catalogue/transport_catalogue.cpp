...
void TransportCatalogue::AddRoute(const std::string& num, const std::vector<std::string>& stops, const std::vector<Stop*> ptrs, bool flag){
...
const Bus* TransportCatalogue::FindRoute(const std::string& num) const{
...
const std::map<std::string_view,Bus*> TransportCatalogue::GetBusCatalogue() const{
    std::map<std::string_view,Bus*> sort_nums;
...
const std::map<std::string_view, Stop*> TransportCatalogue::GetStopCatalogue() const{
...
const std::unordered_set<Stop*> TransportCatalogue::GetListOfUniqueStops() const{
