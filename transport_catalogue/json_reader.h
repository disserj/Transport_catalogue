...
public:
    ...
    std::tuple<std::string_view, std::vector<std::string>, std::vector<transport::Stop*>, bool> FillBuses(const json::Dict& dictionary, transport::TransportCatalogue& catalogue) const;
